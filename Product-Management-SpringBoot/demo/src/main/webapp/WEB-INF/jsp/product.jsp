                  ...
                  <tbody>
                    <c:forEach var="product" items="${products}" varStatus="index">
                      <tr>
                        ...
                        <td>
                          <button onclick="location.href='edit/${book.id}'" type="button" class="btn btn-secondary">
                            Edit
                          </button>
                        </td>
                        <td>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <button onclick="location.href='delete/${book.id}'" type="button" class="btn btn-primary">
                                Yes!
                              </button>
                            </div>
                          </div>
